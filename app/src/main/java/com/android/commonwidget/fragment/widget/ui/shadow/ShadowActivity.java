package com.android.commonwidget.fragment.widget.ui.shadow;
...
@Route(path = ShadowActivity.AROUTER_TAG)
public class ShadowActivity extends AppCompatActivity {
    public static final String AROUTER_TAG = "/commonwidget/ShadowActivity";
